...
class TicketViewAll4 extends StatefulWidget {
  const TicketViewAll4({super.key});

  @override
  State<TicketViewAll4> createState() => _TicketViewAll4State();
}

class _TicketViewAll4State extends State<TicketViewAll4> {
  @override
                    ...
                    MouseRegion(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const TicketViewAll3()), // Navigate to page 1
                          );
                        },
                        child: const Icon(
                          Icons.chevron_left,
