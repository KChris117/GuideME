...
class DestinationsViewAll4 extends StatefulWidget {
  ...
  @override
  State<DestinationsViewAll4> createState() => _DestinationsViewAll4State();
}

class _DestinationsViewAll4State extends State<DestinationsViewAll4> {
  @override
                    ...
                    MouseRegion(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const DestinationsViewAll3()), // Navigate to page 1
                          );
                        },
                        child: const Icon(
                          Icons.chevron_left,
