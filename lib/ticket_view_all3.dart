...
import 'ticket_view_all2.dart';
import 'ticket_view_all4.dart';

class TicketViewAll3 extends StatefulWidget {
  const TicketViewAll3({super.key});

  @override
  State<TicketViewAll3> createState() => _TicketViewAll3State();
}

class _TicketViewAll3State extends State<TicketViewAll3> {
  @override
                    ...
                    MouseRegion(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const TicketViewAll2()), // Navigate to page 1
                          );
                        },
                        child: const Icon(
                          Icons.chevron_left,
                    ...
                    MouseRegion(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const TicketViewAll4()), // Navigate to page 3
                          );
                        },
                        child: const Icon(
                          Icons.chevron_right,
