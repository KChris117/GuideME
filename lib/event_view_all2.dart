...
class EventViewAll2 extends StatefulWidget {
  const EventViewAll2({super.key});

  @override
  State<EventViewAll2> createState() => _EventViewAll2State();
}

class _EventViewAll2State extends State<EventViewAll2> {
  @override
                    ...
                    MouseRegion(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const EventViewAll3()), // Navigate to page 3
                          );
                        },
                        child: const Icon(
                          Icons.chevron_right,
